      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-4">
            Willkommen auf unserer Über-uns-Seite. Hier erfahren Sie mehr über unser Unternehmen und unsere Mission.
          </p>
          
          <p className="mb-4">
            Wir sind ein innovatives Unternehmen, das sich der Entwicklung modernster Webtechnologien widmet. 
            Unser Team besteht aus erfahrenen Entwicklern, die sich leidenschaftlich für sauberen Code und 
